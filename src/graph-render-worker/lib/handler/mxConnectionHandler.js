...
const mxGeometry = require("../model/mxGeometry");
const mxCell = require("../model/mxCell");
const mxPolyline = require("../shape/mxPolyline");
const mxImageShape = require("../shape/mxImageShape");
const mxConstraintHandler = require("./mxConstraintHandler");
const mxCellMarker = require("./mxCellMarker");
...
mxConnectionHandler.prototype.updateCurrentState = function (me, point) {
  ...
  if (
    ...
    if (this.currentState != null && outline) {
      ...
      let constraint = this.graph.getOutlineConstraint(
        point,
        this.currentState,
        me
      );
...
module.exports = mxConnectionHandler;
