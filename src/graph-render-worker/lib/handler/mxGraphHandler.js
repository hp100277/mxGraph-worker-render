...
const mxGuide = require("../util/mxGuide");
const mxRectangleShape = require("../shape/mxRectangleShape");
const mxCellHighlight = require("./mxCellHighlight");
...
mxGraphHandler.prototype.isPropagateSelectionCell = function (
  ...
  if (immediate) {
    let geo = this.graph.model.isEdge(cell)
      ? null
...
mxGraphHandler.prototype.start = function (cell, x, y, cells) {
  ...
  if (this.guidesEnabled) {
    ...
    let opps = this.graph.getOpposites(
