...
const mxSvgCanvas2D = require("../util/mxSvgCanvas2D");
const mxVmlCanvas2D = require("../util/mxVmlCanvas2D");
...
mxText.prototype.updateBoundingBox = function () {
  ...
  if (this.boundingBox != null) {
    if (rot != 0) {
      ...
      let bbox = mxUtils.getBoundingBox(
        new mxRectangle(
...
mxText.prototype.redrawHtmlShapeWithCss3 = function () {
  ...
  mxSvgCanvas2D.createCss(
    ...
    mxUtils.bind(this, function (dx, dy, flex, item, block, ofl) {
      ...
      let html = mxUtils.isNode(this.value)
