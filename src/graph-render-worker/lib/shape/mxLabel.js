...
const mxRectangleShape = require("../mxRectangleShape");
/**
...
mxLabel.prototype.getImageBounds = function (x, y, w, h) {
  ...
  let width = mxUtils.getNumber(
    this.style,
    mxConstants.STYLE_IMAGE_WIDTH,
    mxConstants.DEFAULT_IMAGESIZE
  );
  let height = mxUtils.getNumber(
    this.style,
...
mxLabel.prototype.redrawHtmlShape = function () {
  ...
  if (this.image != null) {
    ...
    let bounds = this.getImageBounds(
      this.bounds.x,
      this.bounds.y,
      this.bounds.width,
      this.bounds.height
