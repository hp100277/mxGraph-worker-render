...
mxCellEditor.prototype.installListeners = function (elt) {
  ...
  let keypressHandler = mxUtils.bind(this, function (evt) {
  ...
  let keyupHandler = mxUtils.bind(this, function (evt) {
    if (this.editingCell != null) {
  ...
  let evtName = !mxClient.IS_IE11 && !mxClient.IS_IE ? "input" : "keydown";

  let resizeHandler = mxUtils.bind(this, function (evt) {
...
mxCellEditor.prototype.startEditing = function (cell, trigger) {
  ...
  if (state != null) {
    ...
    let dir = (this.textDirection = mxUtils.getValue(
      state.style,
...
mxCellEditor.prototype.getEditorBounds = function (state) {
  ...
  if (
    ...
    if (this.graph.getModel().isVertex(state.cell)) {
      let horizontal = mxUtils.getValue(
        state.style,
        mxConstants.STYLE_LABEL_POSITION,
        mxConstants.ALIGN_CENTER
      );
