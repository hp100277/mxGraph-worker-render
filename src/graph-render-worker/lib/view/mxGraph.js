...
const mxResources = require("../util/mxResources");
const mxImage = require("../util/mxImage");
const mxGraphModel = require("../model/mxGraphModel");
const mxTooltipHandler = require("../handler/mxTooltipHandler");
const mxSelectionCellsHandler = require("../handler/mxSelectionCellsHandler");
const mxConnectionHandler = require("../handler/mxConnectionHandler");
const mxGraphHandler = require("../handler/mxGraphHandler");
const mxPanningHandler = require("../handler/mxPanningHandler");
const mxPopupMenuHandler = require("../handler/mxPopupMenuHandler");
const mxGraphSelectionModel = require("./mxGraphSelectionModel");
const mxStylesheet = require("./mxStylesheet");
const mxGraphView = require("./mxGraphView");
const mxCellRenderer = require("./mxCellRenderer");
const mxCellEditor = require("./mxCellEditor");
const mxEdgeStyle = require("./mxEdgeStyle");
...
mxGraph.prototype.sizeDidChange = function () {
  ...
  if (this.container != null) {
    ...
    if (this.preferPageSize || (!mxClient.IS_IE && this.pageVisible)) {
      let size = this.getPreferredPageSize(
        bounds,
        Math.max(1, width),
        Math.max(1, height)
      );
  ...
  if (cells != null && cells.length > 0) {
    ...
    try {
      ...
      for (let i = 0; i < cells.length; i++) {
        ...
        let disconnectTerminal = mxUtils.bind(this, function (edge, source) {
  ...
  if (cell != null) {
    ...
    if (!this.model.isEdge(cell)) {
      ...
      if (value != null && value.length > 0) {
        ...
        let size = mxUtils.getSizeForString(
          value,
          fontSize,
  ...
  if (geo != null) {
    ...
    if (geo.relative && !this.model.isEdge(cell)) {
      ...
      if (angle != 0) {
        ...
        let pt = mxUtils.getRotatedPoint(
          new mxPoint(dx, dy),
          cos,
          sin,
          new mxPoint(0, 0)
...
mxGraph.prototype.scrollCellToVisible = function (cell, center) {
  ...
  if (state != null) {
    ...
    if (this.scrollRectToVisible(bounds)) {
      ...
      let tr2 = new mxPoint(this.view.translate.x, this.view.translate.y);
  ...
  if (source != null && target != null) {
    ...
    if (this.multiplicities != null) {
      for (let i = 0; i < this.multiplicities.length; i++) {
        let err = this.multiplicities[i].check(
          this,
          edge,
          source,
          target,
...
mxGraph.prototype.selectCells = function (
  ...
  let filter = mxUtils.bind(this, function (cell) {
    return (
...
mxGraph.prototype.createHandler = function (state) {
  ...
  if (state != null) {
    if (this.model.isEdge(state.cell)) {
      ...
      let edgeStyle = this.view.getEdgeStyle(
        state,
