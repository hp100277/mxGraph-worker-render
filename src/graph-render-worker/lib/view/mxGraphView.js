...
const mxUndoableEdit = require("../util/mxUndoableEdit");
...
const mxStyleRegistry = require("./mxStyleRegistry");
...
mxGraphView.prototype.validate = function (cell) {
  ...
  self.status = mxResources.get(this.doneResource) || this.doneResource;
