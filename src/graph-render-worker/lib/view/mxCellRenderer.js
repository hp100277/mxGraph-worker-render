...
const mxMouseEvent = require("../util/mxMouseEvent");
...
const mxStencilRegistry = require("../shape/mxStencilRegistry");
const mxShape = require("../shape/mxShape");
const mxConnector = require("../shape/mxConnector");
const mxRectangleShape = require("../shape/mxRectangleShape");
const mxText = require("../shape/mxText");
const mxEllipse = require("../shape/mxEllipse");
const mxRhombus = require("../shape/mxRhombus");
const mxCylinder = require("../shape/mxCylinder");
const mxArrow = require("../shape/mxArrow");
const mxActor = require("../shape/mxActor");
const mxLine = require("../shape/mxLine");
const mxCloud = require("../shape/mxCloud");
const mxHexagon = require("../shape/mxHexagon");
const mxTriangle = require("../shape/mxTriangle");
const mxArrowConnector = require("../shape/mxArrowConnector");
const mxDoubleEllipse = require("../shape/mxDoubleEllipse");
const mxSwimlane = require("../shape/mxSwimlane");
const mxLabel = require("../shape/mxLabel");
 ...
 * (code)
 * mxLog.show();
 * for (let i in mxCellRenderer.defaultShapes)
 * {
 *   mxLog.debug(i);
 * }
 * (end)
...
mxCellRenderer.prototype.createShape = function (state) {
  ...
  if (state.style != null) {
    ...
    let stencil = mxStencilRegistry.getStencil(
...
mxCellRenderer.prototype.resolveColor = function (state, field, key) {
  let shape = key == mxConstants.STYLE_FONTCOLOR ? state.text : state.shape;
    ...
    state.overlays.visit(function (id, shape) {
      ...
      if (!state.view.graph.getModel().isEdge(state.cell)) {
        if (state.shape != null && rot != 0) {
          ...
          let point = mxUtils.getRotatedPoint(
            new mxPoint(cx, cy),
            cos,
            sin,
